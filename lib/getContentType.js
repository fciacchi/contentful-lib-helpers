 ...
 * @returns {Promise<import("contentful-management/dist/types/entities/content-type").ContentType|null>} - A Promise that resolves with the content-type object if it exists, or `null` otherwise.
 *
 * @example
 *
 * Usage:
