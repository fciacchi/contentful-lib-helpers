 ...
 *
 * @param {import("contentful-management/dist/types/entities/space").Space} space - The Contentful Space object
 ...
 * @returns {Promise<import("contentful-management/dist/types/entities/environment").Environment|null>} - A Promise that resolves with the duplicated environment object, or `null` if not found.
 *
 * @example
 *
 * // Usage:
