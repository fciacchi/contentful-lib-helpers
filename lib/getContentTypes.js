 ...
 * @returns {Promise<import("contentful-management/dist/types/common-types").Collection<import("contentful-management/dist/types/entities/content-type").ContentType, import("contentful-management/dist/types/entities/content-type").ContentTypeProps>|{total: number, limit: number, skip: number, sys: {type: string}, items: *[]}>} - A Promise that resolves with a Content-type collection if successful, or an empty collection otherwise.
 *
 * @example
 *
 * Usage:
